...
[source,cypher,severity=major,role=constraint,requiresConcepts="java:PackageDependency"]
...
[source,cypher,severity=blocker,role=constraint,severity="BLOCKER",requiresConcepts="java:ArtifactDependency,packages:Module"]
